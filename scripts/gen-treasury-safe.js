...
const fileContent = `# DARKCITY $STYXX TREASURY — local-only secrets
...
STYXX_TREASURY_PRIVKEY=${privB58}
STYXX_WALLET_ENC_KEY=${encKey}
SOLANA_RPC_URL=https://api.mainnet-beta.solana.com

# Treasury pubkey (safe to share — this is where you send SOL + $STYXX):
# ${pub}
`;
...
console.log('    • 5000 $STYXX  (mint: Dxw3u4KxN32KpSdHSq4TkwjfMPJTPeosa22JXN15pump)');
console.log('');
